//Name : Carl Ferdinand Peralta
//Student ID: 18415304
// OS: Windows 10
// Assignment 02 re-designed
// Factory Method Design Pattern and Bridge Design Pattern
...
namespace MyFactoryMethod
{
    ...
    class PolylineShape : IShape
    {
        ...
        public int StrokeWidth { get; set; }
        public string Fill { get; set; }
        public PolylineShape() { Points = "0,40 40,40 40,80 80,80 80,120 120,120 120,160"; Stroke = "black"; StrokeWidth = rand.Next(1, 5); Fill = "blue";}  //default constructer
                ...
                if (sc.Equals("q") || sc.Equals("Q"))
                {
                    ...
                    switch (sc)
                    {
                        ...
                        case "Rectangle":
                            ...
                            ClientCode(new RectangleFactory(new RedColor()));
                            break;
                        case "Circle":
                            Console.WriteLine("App: Launched with Circle Shape:");
                            ClientCode(new CircleFactory(new RedColor()));
                            break;
                        case "Ellipse":
                            Console.WriteLine("App: Launched with Ellipse Shape:");
                            ClientCode(new EllipseFactory(new BlueColor()));
                            break;
                        case "Line":
                            Console.WriteLine("App: Launched with Line Shape:");
                            ClientCode(new LineFactory(new BlueColor()));
                            break;
                        case "Polyline":
                            Console.WriteLine("App: Launched with Polyline Shape:");
                            ClientCode(new PolylineFactory(new BlueColor()));
                            break;
                        case "Polygon":
                            Console.WriteLine("App: Launched with Polygon Shape:");
                            ClientCode(new PolygonFactory(new BlueColor()));
                            break;
                        case "Path":
                            Console.WriteLine("App: Launched with Path Shape:");
                            ClientCode(new PathFactory(new RedColor()));
                            break;
                        default:
                ...
                else
                {
                    switch (sc)
                    {
                        ...
                        String path = @"./Shapes.svg";
                            ...
                            {
                                sw.WriteLine(@"<svg height=""2000"" width=""2000"" xmlns=""http://www.w3.org/2000/svg%22%22%3E" + Environment.NewLine);
